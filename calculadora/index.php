...
?> 
This is my first php script. you can dowload it <a href="simpcalc.zip">here.</a><br>
Below is a working version of the script...<br><br>**note it seems like the Result is not showing up  too clearly, i originally wanted it to be a script u could just insert, i'll make it appear below now.<br>
